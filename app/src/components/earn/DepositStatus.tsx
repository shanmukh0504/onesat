...
export const DepositStatus = ({
  ...
  const step3Complete = swapState >= 3; // BTC confirmed and conversion started
  ...
  console.log("✅ Step 1 (Created):", step1Complete);
  console.log("✅ Step 2 (BTC Detected):", step2Complete);
  console.log("✅ Step 3 (BTC Confirmed):", step3Complete);
  console.log("✅ Step 4 (Deposited):", step4Complete);
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-4 gap-4 relative">
                <div className="flex flex-col items-start">
                  <div
                    className={`w-4 h-4 rounded-full mb-4 relative z-10 border-2 border-background ${
                      step1Complete ? "bg-primary" : "bg-gray-300"
                    }`}
                  />
                  <div
                    className={`text-base font-medium mb-2 ${
                      step1Complete ? "text-primary" : "text-gray-400"
                    }`}
                  >
                    1
                  </div>
                  <p
                    className={`text-sm ${
                      step1Complete ? "text-foreground" : "text-gray-400"
                    }`}
                  >
                ...
                <div className="flex flex-col items-start">
                  <div
                    className={`w-4 h-4 rounded-full mb-4 relative z-10 border-2 border-background ${
                      step2Complete ? "bg-primary" : "bg-gray-300"
                    }`}
                  />
                  <div
                    className={`text-base font-medium mb-2 ${
                      step2Complete ? "text-primary" : "text-gray-400"
                    }`}
                  >
                    2
                  </div>
                  <p
                    className={`text-sm ${
                      step2Complete ? "text-foreground" : "text-gray-400"
                    }`}
                  >
                ...
                <div className="flex flex-col items-start">
                  <div
                    className={`w-4 h-4 rounded-full mb-4 relative z-10 border-2 border-background ${
                      step3Complete ? "bg-primary" : "bg-gray-300"
                    }`}
                  />
                  <div
                    className={`text-base font-medium mb-2 ${
                      step3Complete ? "text-primary" : "text-gray-400"
                    }`}
                  >
                    3
                  </div>
                  <p
                    className={`text-sm ${
                      step3Complete ? "text-foreground" : "text-gray-400"
                    }`}
                  >
                ...
                <div className="flex flex-col items-start">
                  <div
                    className={`w-4 h-4 rounded-full mb-4 relative z-10 border-2 border-background ${
                      step4Complete ? "bg-primary" : "bg-gray-300"
                    }`}
                  />
                  <div
                    className={`text-base font-medium mb-2 ${
                      step4Complete ? "text-primary" : "text-gray-400"
                    }`}
                  >
                    4
                  </div>
                  <p
                    className={`text-sm ${
                      step4Complete ? "text-foreground" : "text-gray-400"
                    }`}
                  >
                    Deposit Success
                  </p>
