...
const Navbar: React.FC<NavbarProps> = ({ className }) => {
    ...
    const displayAddress = bitcoinPaymentAddress || starknetAddress || stacksAddress;
            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                                ...
                                >
                                    {displayAddress && (
                                        <Avatar
                                            ...
                                            name={displayAddress}
                                            variant="beam"
                                            colors={["#E6F2FF", "#C6DFFF", "#B793FC", "#8B9EFF", "#E0BEFD"]}
                                        />
                                    )}
                ...
                >
                    <div className="w-6 h-6 flex flex-col justify-center space-y-1">
                        <span className={cn('block h-0.5 w-6 bg-black transition-all duration-300', isMenuOpen && 'rotate-45 translate-y-1.5')} />
                        <span className={cn('block h-0.5 w-6 bg-black transition-all duration-300', isMenuOpen && 'opacity-0')} />
                        <span className={cn('block h-0.5 w-6 bg-black transition-all duration-300', isMenuOpen && '-rotate-45 -translate-y-1.5')} />
                    </div>
                </button>
            </div>
                                    ...
                                    {!connected ? (
                                        ...
                                        <div className="space-y-3">
                                                ...
                                                <div className="flex flex-col space-y-2 text-sm font-mono text-gray-700">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <span className="text-green-600 font-medium">
                                                            {isXverseAvailable ? 'Xverse detected' : 'Xverse not detected'}
                                                        </span>
                                                    </div>
                                                    {bitcoinPaymentAddress && (
                                                        <div className="flex items-center justify-between">
                                                            <span className="opacity-70">BTC</span>
                                                            <span className="truncate max-w-[60%]" title={bitcoinPaymentAddress}>
                                                    ...
                                                    {starknetAddress && (
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            <span className="truncate max-w-[60%]" title={starknetAddress}>
                                            ...
                                            <div className="flex items-center space-x-3 mt-4">
                                                ...
                                                <span className="font-mono text-xs break-all">{short(displayAddress)}</span>
                                            </div>
                                        </div>
                                    )}
                                </div>
